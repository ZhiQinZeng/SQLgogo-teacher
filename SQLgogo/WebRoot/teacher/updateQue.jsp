...
<div class="container-fluid" style="position: absolute;top: 90px;left: 300px" >
	...
	<div align="center" style="position: absolute;top: 90px;left: 160px;width:800px;">
		<font size="5">修改题库信息</font>
		<hr>
		
		<input style="display:none" id="myid" value=<%=request.getParameter("upid") %> >
	
		 <div class="layui-form-item">
		    <label class="layui-form-label">名称：</label>
		    <div class="layui-input-block">
		      <input type="text" name="quename" id="quename" lay-verify="title" autocomplete="off" placeholder="请输入题目标题" class="layui-input" value=<%=request.getParameter("quename") %>>
		    </div>
  		</div> 
		 ...
		 <div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-block">
		    	<textarea placeholder="请输入题目内容" class="layui-textarea" name="quecontext" id="quecontext" value=<%=request.getParameter("quecontext") %>><%=request.getParameter("quecontext") %></textarea>
    		</div>
  		</div>
...
function confirm(){
	...
	if(quename == "" || quecontext == ""){
		...
		$.ajax({
		  url:"../QueManager?method=updateQue",
		  type:"post",
		  data:{
		  	"myid":myid,
		  	"quename":quename,
