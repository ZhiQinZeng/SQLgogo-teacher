...
<script type="text/javascript" src="js/UpdateSubject.js"></script>
...
<body onload="nav()">
	...
	<input id="subid" style="display:none" value=<%=request.getParameter("upid") %>>
	<div class="container-fluid"
		style="position: absolute;top: 160px;left: 350px">
		<div id="contain" style="display:flex; flex-direction: column;">
			<p style="font-size: 30px;font-weight: bold;">问题修改</p>

			<div>
				<p>1.问题名称：</p>
				<input class="form-control" aria-describedby="basic-addon1"
					style="width: 300px;" id="sub_name" type="text" placeholder="试题名称" value=<%=request.getParameter("subjectName") %>>
			</div>
			...
			<div id="prac_protray"
				...
				<div>
					...
					<textarea id="textarea" class="form-control" rows="3" cols=""
						onfocus="textFocus()"
						style="width: 500px;height: 164px;"><%=request.getParameter("subject_detail") %></textarea>
				</div>
			</div>
			...
			<div>
				...
				<textarea id="textarea2" class="form-control" rows="3" cols=""
					onfocus="textFocus2()"
					style="height: 164px;width:500px;"><%=request.getParameter("subject_answer") %></textarea>
			</div>		
			 ...
			 <div style="margin-top: 78px;">
			   <p style="margin-bottom:4px;">请输入自定义问题分数</p>
			       <input class="form-control" aria-describedby="basic-addon1" style="width: 60px;" id="self_score" type="text" placeholder="" value=<%=request.getParameter("set_score") %>>
			   </div>
			</div>
			   </div>
