...
function exit(){
	...
	function submit(){
	    ...
	    console.log(likes)
	    $.post("../SubjectServlet?status=updateBysubid",{subid:subid,sub_name:sub_name,sub_protray:sub_protray,sub_answer:sub_answer,keys:keys,total:self_score},function(data){
