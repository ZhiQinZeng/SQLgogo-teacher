...
<html>
  <head>
    ...
    <script src="<%=request.getContextPath() %>/teacher/js/updateStudent.js" ></script>
  ...
  <div class="container-fluid" style="position: absolute;top: 50px;left: 300px" >
 	...
 	<div align="center" style="position: absolute;top: 113px;left: 160px;width:800px;>
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
 			 <legend style="border-bottom: 0px;font-size:26px;color:#545454 ">学生信息修改</legend>
		</fieldset>
	 ...
	 <input id="username" style="display:none;" value=<%=request.getParameter("username") %>>
		 ...
		 <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input type="text" name="studentname" id="studentname" lay-verify="title" autocomplete="off" value="<%=request.getParameter("realname")%>" class="layui-input">
		    </div>
  		</div> 
  		...
  		<div class="layui-form-item">
           ...
           <ul class="dropdown-menu" aria-labelledby="dropdownMenu" id="select">
			  ...
			  <!--  	<select name="quiz2" lay-verify=""  id="select">
		...
		<div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-block">
		    	<textarea placeholder="请输入学生学号" class="layui-textarea" name="studentsnum" id="studentsnum" ><%=request.getParameter("username")%></textarea>
    		</div>
  		</div>
