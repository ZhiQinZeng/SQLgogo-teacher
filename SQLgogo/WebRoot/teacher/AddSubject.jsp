...
<body onload="nav()">
	...
	<div class="container-fluid"
		...
		<div id="contain" style="display:flex; flex-direction: column;">
			<p style="font-size: 30px;font-weight: bold;">自定义问题</p>
			...
			<div id="prac_protray"
				...
				<div>
					...
					<textarea id="textarea" class="form-control" rows="3" cols=""
						onfocus="textFocus()"
						style="width: 500px;height: 164px;" placeholder="描述一下你要发布的试题"></textarea>
				</div>
			</div>
			...
			<div>
				...
				<textarea id="textarea2" class="form-control" rows="3" cols=""
					onfocus="textFocus2()"
					style="height: 164px;width:500px;" placeholder="请输入试题答案"></textarea>
			</div>		
			...
			<div id="prac_class" style="margin-top:20px;">
				<a id="fanhui" href="#" onclick="javascript :history.back(-1);"><button type="button" id="submit" class="btn btn-default"
					style="margin-left: 450px;background-color: #1e88e5;color: white;">返回</button></a>
